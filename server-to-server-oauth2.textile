h1. Server til server autorisasjon med Oauth2
...
h2. Krav til JWT for token-forespørsel
...
p. Eksempel på en respons ved suksessfull validering av token:
...
p. Eksempel på en respons ved feilet validering av token:

pre.. {
    "active": false
}  
 
h2. Eksempel på generering av JWT for token-forespørsel i Java
...
pre.. PrivateKey myKey = ... // Read from KeyStore
